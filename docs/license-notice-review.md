...
| USDA FoodData Central Foundation, FNDDS, and SR Legacy records | CC0 1.0 Universal | `foods_reference`; production bulk data imported by operators and not bundled; Branded Foods remain assessment-only; small test fixtures identified separately | FoodData Central source retained per record and shown in the UI; suggested USDA source credit in `NOTICE.md` | Approved |
