...
Unbranded protein powders, milks, brans, seeds, and other powdered foods with public-domain nutrient data.

## Data method

25 entries reproduce USDA FoodData Central nutrient profiles. Values use a per-100-gram basis and every entry includes at least one named household
