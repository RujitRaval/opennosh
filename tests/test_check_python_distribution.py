...
WHEEL_MEMBERS = {
    ...
    "opennosh_api/public-status.v1.json": b"{}",
    "opennosh_api/public-status.schema.json": b"{}",
    "opennosh_api/publication-readiness.schema.json": b"{}",
    "opennosh_api/impact-metrics.v1.json": b"{}",
    "opennosh_api/usda-reference-release.v1.json": b"{}",
    "opennosh_api/usda-branded-assessment.v1.json": b"{}",
    "opennosh_api/contracts/developer-compatibility.schema.json": b"{}",
    "opennosh_api/contracts/developer-integration-trial.schema.json": b"{}",
