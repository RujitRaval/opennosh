...
export const enCatalog = {
  metadata: {
    ...
    homeDescription: "An open food-data beta with public search, source context, owner-reviewed contributions, and a private nutrition tracker.",
    ...
    reuseTitle: "Reuse registry - opennosh",
    reuseDescription: "Inspect public reuse declarations and verified dependency evidence.",
    impactTitle: "Commons impact - opennosh",
    impactDescription: "Inspect privacy-safe, proof-bound measures of commons reuse and activity.",
    statusTitle: "System status - opennosh",
    statusDescription: "Inspect public component health and privacy-safe incident updates.",
  },
  common: {
    home: "Home",
    explore: "Explore",
  ...
  embed: {
    ...
    staleVerified: "Stale, cryptographically verified",
    nutrients: "Nutrients per 100 grams",
    directProvenance: "View direct provenance",
    openProvenance: "Open the verified provenance document",
    noProvenance: "No separate provenance note was supplied.",
    proofRequired: "Proof required",
    notFoundTitle: "Record not found",
    notFoundBody: "This embed does not match a public OpenNosh food record.",
    unavailableTitle: "Verified record unavailable",
    unavailableBody: "OpenNosh cannot prove this record right now, so the embed is withheld.",
  },
  shell: {
  ...
  navigation: {
    ...
    pilotTitle: "How this beta accepts contributions",
    pilotBody: "The guided form saves a draft on this device. For a first contribution, open a GitHub issue with the food name, locale, and a public source, or send it to support@opennosh.org. The owner will help choose the right pack and review route. Photo uploads and automatic publication are not available in this pilot.",
    pilotReview: "Rujit Raval reviews food suggestions weekly when capacity allows. Owner approvals are labeled; they are not independent review. Accepted records appear publicly only after publication is verified.",
    pilotLink: "Suggest a food on GitHub",
    developerTitle: "Make your first public request",
    developerBody: "Read the public catalogue without an account or API key. The JavaScript and Python starters show how to keep source, license, attribution, and release proof attached.",
    developerLink: "JavaScript and Python starters",
    selfHostLink: "Install your own instance",
    hubs: {
      explore: {
        label: "Explore",
      ...
      contribute: {
        label: "Contribute",
        description: "Help document a missing food in this owner-reviewed beta. Keep its source, preparation, and locale attached.",
      ...
      build: {
        ...
        action: "Try the developer quick start",
        compactAction: "Quick start",
    ...
    children: {
      ...
      reuse: { label: "Reuse registry", description: "See who declares reuse and which dependencies have verified proof." },
      impact: { label: "Commons impact", description: "See proof-bound totals and only privacy-safe regional cohorts." },
      status: { label: "System status", description: "See component health and public incident updates." },
    },
  },
  home: {
    ...
    heroMeta: "The open food commons · beta",
    ...
    searchNext: "Find a food. Follow its source.",
    ...
    contributeDescription: "This beta is operated and reviewed by the project owner. Suggest a missing food with a public source; accepted changes are published with their review history.",
    chapters: [
      ...
      { label: "Chapter 03", title: "Sources + review", description: "The owner reviews the source and publishes accepted records. Submission alone does not publish a food." },
    ],
  ...
  search: {
    liveLabel: "Open catalog / live",
    title: "Search food records.",
    description: "Search signed community records and USDA FoodData Central references together. Their counts stay separate so verified community work is never confused with imported reference data.",
    catalogCounts: "Current food catalog counts",
    signedCommunityRecords: "Signed community records",
    usdaReferenceFoods: "USDA reference foods",
    communitySource: "Community",
    usdaSource: "USDA FoodData Central",
    foodName: "Food name",
    placeholder: "Try dal, paneer, tofu…",
    searching: "Searching…",
    submit: "Search records",
    errorFallback: "Search could not be completed.",
    empty: "No matching food record yet. You can help add one through Contribute.",
  ...
  livingCommons: {
    reuse: {
      eyebrow: "Living Commons / reuse",
      title: "Reuse stays visible.",
      lead: "Public declarations distinguish community statements from verified evidence. Dependency edges appear only when their source artifact and observation date are proven.",
      unavailableTitle: "Reuse proof is unavailable.",
      unavailableBody: "The registry could not validate both declarations and dependency evidence, so neither is shown.",
      emptyTitle: "No public reuse declarations yet.",
      emptyBody: "Declarations remain absent until the public registry returns a valid, bounded response.",
      registryEyebrow: "Public declarations",
      registryTitle: "Who says they reuse the commons",
      dependencyEyebrow: "Verified dependency evidence",
      dependencyTitle: "What downstream work depends on",
      noDependencies: "No verified dependency edges are public yet.",
      labels: { community_declared: "Community declared", unverified: "Unverified", verified: "Verified" },
      projectUrl: "Declared project URL",
      revision: "Revision",
      updated: "Updated / UTC",
      region: "Broad region",
    ...
    impact: {
      eyebrow: "Living Commons / impact",
      title: "Impact without surveillance.",
      lead: "Global measures come from a versioned checkpoint. Regional activity appears only in broad cohorts that independently meet the privacy threshold; there are no filters, hidden totals, or contributor locations.",
      unavailableTitle: "Impact proof is unavailable.",
      unavailableBody: "The complete projection could not be validated, so no count or regional inference is shown.",
      zeroTitle: "Verified impact is currently zero.",
      zeroBody: "The checkpoint is valid and contains no qualifying activity yet.",
      globalEyebrow: "Proof-bound totals",
      globalTitle: "Commons activity at a glance",
      checkpoint: "Checkpoint {checkpoint}",
      none: "none",
      privacyEyebrow: "Privacy threshold / {count}",
      regionsTitle: "Broad regions that meet the threshold",
      regionsLead: "Each published region has at least ten independently counted events in one permitted metric.",
      noRegions: "No broad region independently meets the privacy threshold.",
      metrics: {
        verified_adopters: "Verified adopters",
        community_declarations: "Community declarations",
        accepted_contributions: "Accepted contributions",
        pack_installs: "Pack installs",
        api_reads: "API reads",
        artifact_downloads: "Artifact downloads",
      },
      regionAdopters: { one: "{count} verified adopter", other: "{count} verified adopters" },
      regionDeclarations: { one: "{count} declaration", other: "{count} declarations" },
      regionContributions: { one: "{count} contribution", other: "{count} contributions" },
    },
    status: {
      eyebrow: "Living Commons / operations",
      title: "Health, with proof attached.",
      lead: "A fixed public component inventory reports fresh monitor evidence or an explicit unknown state. Incident text excludes infrastructure identifiers, credentials, and raw logs.",
      unavailableTitle: "Public status proof is unavailable.",
      unavailableBody: "Component and incident responses did not validate together, so no operational claim is shown.",
      componentsEyebrow: "Fixed component inventory",
      componentsTitle: "Current component health",
      incidentsEyebrow: "Public incident ledger",
      incidentsTitle: "Incidents and verified recovery",
      noIncidents: "No public incidents are recorded.",
      monitorVerified: "Fresh monitor evidence verified.",
      noObservation: "No valid observation",
      configuration: "Configuration digest",
      none: "none",
      guidance: "Guidance",
      recovery: "Verified recovery",
      states: { operational: "Operational", degraded: "Degraded", outage: "Outage", maintenance: "Maintenance", unknown: "Unknown" },
      reasons: { missing_evidence: "Monitor evidence is missing.", stale_evidence: "Monitor evidence is stale.", malformed_evidence: "Monitor evidence is malformed." },
      incidentStates: { investigating: "Investigating", identified: "Identified", monitoring: "Monitoring", resolved: "Resolved" },
    },
  },
  contribution: {
    chapters: {
    ...
    citation: {
      referenceOnly: "Reference only — cite the source without copying its files",
      publisher: "Source publisher",
      publisherPlaceholder: "For example, Haldiram’s",
      notice: "Confirm that you reviewed this public source. We preserve its citation, not a copy of the page or image. Enter only factual details in your own words.",
      publisherRequired: "Enter the publisher of the source you reviewed.",
      versionMismatch: "The saved citation does not match this version. Reopen the evidence step before submitting.",
    },
  ...
  notices: {
    ...
    hostedTitle: "Hosting and your data",
    hostedOperator: "The opennosh.org beta is operated by Rujit Raval. The application and private account database run on Render in Ohio, United States. Cloudflare provides the domain and public delivery infrastructure. Self-hosted instances are controlled by their own operators.",
    hostedPrivate: "Your email, password hash, recovery-code hash, settings, and Tracker records are stored to run your account. Private means they are separated from other users and public datasets; the hosted service is not end-to-end encrypted. The operator and infrastructure providers can process stored data to operate and maintain the service.",
    hostedLocal: "Session and security cookies keep you signed in and protect requests. Interface preferences and unfinished contribution drafts may be stored in your browser. Clear site data on a shared device to remove those local drafts. Do not put private health information in a public contribution or GitHub issue.",
